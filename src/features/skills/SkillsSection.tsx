    ...
    <section id="skills" className="py-24 relative bg-grid-pattern bg-slate-50/50 dark:bg-slate-950/80 text-slate-900 dark:text-white transition-colors duration-300 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-600/10 text-blue-600 dark:text-blue-400 border border-blue-600/20 shadow-sm whitespace-nowrap">
            <Code2 className="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0" />
            <span>{t('skills.sectionBadge')}</span>
          </div>

          <h2 className="text-3xl sm:text-5xl font-extrabold font-heading tracking-tight text-slate-900 dark:text-white leading-[1.25]">
            {t('skills.title')}{' '}
