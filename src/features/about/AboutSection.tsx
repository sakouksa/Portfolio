          ...
          <motion.div variants={fadeIn('left', 0.3)} className="lg:col-span-5">
            <div className="glass-card rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl gradient-border overflow-hidden">
              <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl">
                {/* Card Header */}
                <div className="px-7 py-4.5 border-b border-slate-200/80 dark:border-slate-800 bg-slate-100/60 dark:bg-slate-800/40 flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-blue-600/10 text-blue-600 dark:text-violet-400 border border-blue-600/20">
                    {t('about.verifiedStats')}
                  </span>
                </div>

                {/* Metrics Grid */}
                <div className="grid grid-cols-2 divide-x divide-y divide-slate-200/70 dark:divide-slate-800">
                  {/* Metric 1 */}
                  <div className="flex flex-col gap-2 p-6 sm:p-7 group hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-colors">
                    <div className="flex items-center justify-between">
                      <span className="text-3xl sm:text-4xl font-extrabold font-heading text-blue-600 dark:text-violet-400 leading-none">
                  ...
                  <div className="flex flex-col gap-2 p-6 sm:p-7 group hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-colors">
                    <div className="flex items-center justify-between">
                      <span className="text-3xl sm:text-4xl font-extrabold font-heading text-violet-600 dark:text-cyan-400 leading-none">
                  ...
                  <div className="flex flex-col gap-2 p-6 sm:p-7 group hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-colors">
                    <div className="flex items-center justify-between">
                      <span className="text-3xl sm:text-4xl font-extrabold font-heading text-cyan-600 dark:text-emerald-400 leading-none">
                  ...
                  <div className="flex flex-col gap-2 p-6 sm:p-7 group hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-colors">
                    <div className="flex items-center justify-between">
                      <span className="text-3xl sm:text-4xl font-extrabold font-heading text-emerald-600 dark:text-blue-400 leading-none">
                        {DEVELOPER_PROFILE.githubStars}+
                      </span>
                      <Star className="w-4 h-4 text-emerald-600 dark:text-blue-400 opacity-60 group-hover:opacity-100 transition-opacity" />
                    </div>
                    <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 font-medium leading-snug">
                      {t('about.metricStars')}
                    </span>
